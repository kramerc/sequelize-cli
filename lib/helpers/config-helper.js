...
module.exports = {
  ...
  supportsLanguage: function (language, options) {
    var config = null;
    ...
    return args[language] || config[language];
  },

  supportsCoffee: function (options) {
    return this.supportsLanguage('coffee', options);
  },

  supportsEs6: function (options) {
    return this.supportsLanguage('es6', options);
  },
